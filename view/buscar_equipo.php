            ...
            <div class="card ">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-4">
                    <input type="text" id="text_documento" class="form-control form-control-sm" placeholder="Telefono del Cliente">
                  </div>
...
<script>
  ...
  function validar(){
    let nit = document.getElementById('text_documento').value;
    if (nit.length == 0 ) {
    return Swal.fire("Mensaje de Advertencia","Ingrese Numero de telefono del Cliente registrado","warning");
      }
