                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <label for="">&nbsp;</label><br>
                                    <button class="btn btn-info btn-sm" onclick="Listar_Venta_del_dia(); validar();"><i
                            ...
                            <div class="row">
                                ...
                                <div class="col-5">
                                    ...
                                    <select class="form-control form-control-sm js-example-basic-single"
                                        id="select_mes_venta" style="width: 100%">
                                ...
                                <div class="col-5">
                                    <label for="">Año</label>
                                    <select class="form-control form-control-sm js-example-basic-single"
                                        id="select_anio_venta" style="width: 100%"> </select>
                                </div>

                                <div class="col-2">
                                    <label for="">&nbsp;</label><br>
                                    <button class="btn btn-info btn-sm" onclick="Listar_VentaMes_anio();validar();"><i
                                            class="fas fa-search"></i></button>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <label for="">Año</label>
                                    <select class="form-control form-control-sm js-example-basic-single"
                                        id="select_anio_venta02" style="width: 70%"> </select>
                                </div>
                                <div>
                                    <label for="">&nbsp;</label><br>
                                    <button class="btn btn-info btn-sm" onclick="Listar_Venta_anioM();validar2();"><i
                                            class="fas fa-search"></i></button>
                                </div>
