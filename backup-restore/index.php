<?php
define("BASE_URL", "/Dk_Store_v1/backup-restore/");
define("ROOT_PATH",  $_SERVER["DOCUMENT_ROOT"] . "/Dk_Store_v1/backup-restore/");
...
<head>
    ...
    <meta name="viewport"
        content="width-device-width, user-scalable=no, initial-scale=1.0, maiximum-scale=1.0, minimum-scale=1.0">
    ...
    <div class="login-wrap swing">
        <div class="login-html">
            <input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1"
                class="tab hand">BACKUP</label>

            <input id="tab-2" type="hidden" <?= $checked; ?> name="tab" class="sign-up"><label for="tab-2"
                class="tab hand" hidden="">RESTAURAR</label>
            <div class="login-form">
                ...
                <form class="sign-in-htm" action="?" method="POST" name="form-in" onsubmit="return false">
                    ...
                    <div class="group">
                        ...
                        <input id="host" name="host" type="text" class="input threed" value="<?= $host; ?>"
                            placeholder="localhost" required>
                    </div>
                    <div class="group">
                        <label for="port" class="label">Port:</label>
                        <input id="port" name="port" type="number" class="input threed" value="<?= $port; ?>"
                            placeholder="3306" required>
                    </div>
                    <div class="group">
                        <label for="user" class="label">Usuario:</label>
                        <input id="user" name="user" type="text" class="input threed" value="<?= $user; ?>"
                            placeholder="root" required>
                    </div>
                    <div class="group">
                        <label for="pwd" class="label">Contraseña:</label>
                        <input id="pwd" name="pwd" type="password" class="input threed" value="<?= $pwd; ?>"
                    ...
                    <div id="select_database" class="group">
                        ...
                        <select class="input threed" id="list_db" required name="name_db"
                            style="background-color: #515e8245; opacity: 0.5">
                ...
                <!-- ===============================================================================
                     RESTORE
                    =================================================================================-->
                <form class="sign-up-htm" action="?" method="POST" enctype='multipart/form-data' name="myForm">
                    <input name="restore" type="hidden" value="1">
                    <div class="group">
                        <label for="host2" class="label">Host:</label>
                        <input id="host2" type="text" name="host" class="input threed" value="<?= $host; ?>"
                            placeholder="localhost" required>
                    </div>
                    <div class="group">
                        <label for="port2" class="label">Port:</label>
                        <input id="port2" name="port" type="number" class="input threed" value="<?= $port; ?>"
                            placeholder="3306" required>
                    </div>
                    <div class="group">
                        <label for="user2" class="label">Usuario:</label>
                        <input id="user2" type="text" name="user" class="input threed" value="<?= $user; ?>"
                            placeholder="root" required>
                    </div>
                    <div class="group">
                        <label for="pwd2" class="label">Contraseña:</label>
                        <input id="pwd2" type="password" name="pwd" class="input threed" value="<?= $pwd; ?>"
                            placeholder="Tu contraseña">
                    </div>
                    <div class="group">
                        <label for="name_db" class="label">Nombre DB:</label>
                        <input id="name_db" type="text" name="name_db" class="input threed" value="<?= $name_db; ?>"
                            placeholder="Nombre de bd" required>
                    </div>
                    <div class="group">
                        <label for="file_db" class="label">Archivo .sql:</label>
                        <input id="file_db" type="file" accept=".sql" name="file_db" class="input threed"
                            value="<?= $file_sql; ?>" required>
                    </div>
