<?php 
	...
	$consulta = $MCAJA->Registrar_Cierre_caja($monto_ventas,$cant_ventas,$monto_gasto,$cant_gasto,$monto_total, $monto_servicio,$cant_servicio);//llamamos al metodo del modelo
	echo $consulta;
