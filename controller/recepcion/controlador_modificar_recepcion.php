<?php 
	...
	$consulta = $MREC->Modificar_Recepcion($id,$cliente,$equipo,$caracteristicas,$motivo,$concepto,$monto,$estado,$adelanto,$debe,$accesorios,$fentrega,$marca,$recoger);//llamamos al metodo del modelo
	echo $consulta;
