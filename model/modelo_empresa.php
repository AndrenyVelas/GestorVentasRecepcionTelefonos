<?php 
	...
	class Modelo_Empresa extends conexionBD
	{
		 ...
		 /**************************************************
 		       MODIFICAR EMPRESA
 		  **************************************************/
		 public function Modificar_Empresa($id,$razon,$ruc,$repre,$direccion,$celular,$telefono,$correo,$estado,$url,$cuenta01,$nro_cuenta01,$cuenta02,$nro_cuenta02 )//viene del controlador
		 {
			$c = conexionBD:: conexionPDO();
