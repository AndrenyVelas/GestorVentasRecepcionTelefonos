...
class Modelo_Cliente extends conexionBD
{
	...
	/**************************************************
 		       REGISTRAR CLIENTE
	 **************************************************/
	public function Registrar_Cliente($nombre, $nit, $cel, $direccion, $apellidop, $apellidom, $correo, $tipo_doc) //viene del controlador
	{
		$c = conexionBD::conexionPDO();
	 ...
	 **************************************************/
	//modificar Rol
	public function Modificar_Cliente($id, $nombre, $nit, $cel, $estado, $direccion, $apellidop, $apellidom, $correo, $tipo_doc) //viene del controlador
	{
		$c = conexionBD::conexionPDO();
