<?php 
	...
	class Modelo_Venta extends conexionBD
	{
		 ...
		 /**************************************************
 		  ...
 		  **************************************************/
		 public function Listar_Venta($finicio,$ffin)
		 {
		 ...
		 public function Listar_Selec_Productos_en_combo()
		 {
 		  ...
 		  **************************************************/
		 public function Registrar_Venta($idcliente,$compro,$serie,$numero,$impuesto,$total,$tipo,$porcentaje,$idusuario,$idformapago, $observacion)//viene del controlador
		 {
			$c = conexionBD:: conexionPDO();
		   ...
		   /**************************************************
 		      REGISTRAR DETALLE
 		  **************************************************/
		 public function Registrar_Detalle_Venta($id,$array_producto,$array_cantidad,$array_precio)//viene del controlador
		 {
			$c = conexionBD:: conexionPDO();
