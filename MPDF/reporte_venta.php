	...
	if ($row1['compro_id'] == 2) {
		$html .= '
          ...
          <tr>
            ...
            <barcode code="' . $row1['cliente_nombres'] . '|' . ($row1['venta_comprobante'] . '-' . $row1['venta_serie'] . '-' . $row1['venta_num_comprobante']) . '|' . $row1['venta_total'] . '" type="QR" class="barcode" size="1" disableborder="1" />
            </td>
          </tr>
          ...
          <tr>
            <td colspan="3" class="grand total" style="border-bottom:0px; border-top:0px;border-right:0px;  border-left:0px;"><b>TOTAL $. :</b></td>
