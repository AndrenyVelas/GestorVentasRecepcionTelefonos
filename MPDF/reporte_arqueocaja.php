...
$mpdf = new \Mpdf\Mpdf(['mode' => 'utf-8', 'format' => [80, 110]]);
...
$html.='	
	...
	<h5 style="text-align:center;display: inline-block;margin: 0px;padding: 0px; ">COMPROBANTE DE CIERRE DE CAJA</h5>
	-----------------------------------------<br>
	...
	------------------------------------------<br>
	<h6 style="display: inline-block;margin: 0px;padding: 0px;  font-weight:normal;">Monto Apertura&nbsp; : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Q.  '.$row1['caja_monto_inicial'].'</h6> 
	<h6 style="display: inline-block;margin: 0px;padding: 0px;  font-weight:normal;">Monto Ventas&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;&nbsp;&nbsp;Q. '.$row1['caja_monto_final'].'&nbsp;('.$row1['caja_total_ingreso'].')</h6>
	<h6 style="display: inline-block;margin: 0px;padding: 0px;  font-weight:normal;">Monto Servicio&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;&nbsp;&nbsp;Q.  '.$row1['caja_monto_servicio'].'&nbsp;&nbsp;('.$row1['caja_total_servicio'].')</h6>
	<h6 style="display: inline-block;margin: 0px;padding: 0px;  font-weight:normal;">Monto Egresos&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;&nbsp;&nbsp;Q.  '.$row1['caja_monto_egreso'].'&nbsp;&nbsp;('.$row1['caja_total_egreso'].')</h6></b>
	------------------------------------------<br>
	<h6 style="display: inline-block;margin: 0px;padding: 0px;  font-size:11px">Monto Total&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;&nbsp;&nbsp;Q.  '.$row1['caja_monto_total'].' </h6>
