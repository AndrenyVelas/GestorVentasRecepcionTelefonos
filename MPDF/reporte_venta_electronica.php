...
while ($row1 = $resultado->fetch_assoc()) {
	...
	Direcci&oacute;n:&nbsp; ' . $row1['cliente_direccion'] . '<br><br>';
	$html .= '
	...
	while ($row2 = $resultado2->fetch_assoc()) {
        ...
        <tr>
            <td>' . $contador . '</td>
            <td>' . $row2['producto_nombre'] . ' - Q. ' . $row2['vdetalle_precio'] . '</td>
	...
	if ($row1['compro_id'] == 2) {
        ...
        <tr >
          ...
          <tr>
            <td colspan="3" style="text-align:right;font-size:12px">SUBTOTAL Q. :</td>
          ...
          <tr>
            <td colspan="3" style="text-align:right;font-size:12px"><b>TOTAL Q. :</b></td>
	...
	<table>
	     ...
	     <tr>
           ...
           <tr>
	            ...
	            <barcode code="' . $row1['cliente_nombres'] . '|' . ($row1['venta_comprobante'] . '-' . $row1['venta_serie'] . '-' . $row1['venta_num_comprobante']) . '|' . $row1['venta_total'] . '" type="QR" class="barcode" size="0.5" disableborder="1" />
	            </td>
           </tr>
        	<tr>
