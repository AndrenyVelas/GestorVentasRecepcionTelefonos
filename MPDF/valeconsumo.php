      ...
      <table  style="border-collapse; " border="1" >
        ...
        $html.='
          ...
          <tr>
            ...
            <barcode code="'.$row1['cliente_nombres'].'|'.$row1['cliente_nit'].'|'.($row1['venta_comprobante'].'-'. $row1['venta_serie'].'-'. $row1['venta_num_comprobante']).'|'.$row1['venta_total'].'" type="QR" class="barcode" size="1" disableborder="1" />
            </td>
          </tr>
